...
🌡️ Real-time temperature, humidity, pressure, and visibility

🌅 Sunrise & Sunset timings

🌫️ Air Quality Index (AQI) details (CO, SO₂, NO₂, O₃)

📅 5-day weather forecast

🎨 Clean and responsive UI with glassmorphism design
...
Handling real-time data and updating UI dynamically.
...
🔐 Secure API handling using backend (Node.js)
